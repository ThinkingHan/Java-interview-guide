...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图1.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图2.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图3.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图4.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图5.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图6.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图7.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图8.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图9.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图10.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图11.png)

### ④分代收集算法

当前商业虚拟机都采用分代收集的垃圾收集算法。分代收集算法，顾名思义是根据对象的存活周期将内存划分为几块。一般包括年轻代、老年代 和 永久代，如图所示：

![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图12.png)

## 10.说一下 JVM 有哪些垃圾回收器？

如果说垃圾收集算法是内存回收的方法论，那么垃圾收集器就是内存回收的具体实现。下图展示了7种作用于不同分代的收集器，其中用于回收新生代的收集器包括Serial、PraNew、Parallel Scavenge，回收老年代的收集器包括Serial Old、Parallel Old、CMS，还有用于回收整个Java堆的G1收集器。不同收集器之间的连线表示它们可以搭配使用。

![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图13.png)
...
![图片](E:\工作007-MD\图片库\5. Java虚拟机(JVM)面试题 - 图14.png)
